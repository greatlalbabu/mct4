        ...
        <div className="flex h-16 items-center">
          ...
          <div className="ml-4 flex lg:ml-0">
            <Link to={'/'} className='flex'>
              <div className="flex ">
                <h1 className=' text-2xl font-bold text-yellow  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>Amazon</h1>
              </div>
            </Link>
          </div>
          ...
          <div className="ml-auto flex items-center">
            <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
              ...
              <Link to={'/allproducts'} className="text-sm font-medium text-blue-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                All Products
              </Link>
              <Link to={'/order'} className="text-sm font-medium text-blue-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                Order
              </Link>
              <Link to={'/dashboard'} className="text-sm font-medium text-blue-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                Admin
              </Link>

              <a className="text-sm font-medium text-blue-700 cursor-pointer  " style={{ color: mode === 'dark' ? 'white' : '', }}>
                Logout
              </a>
            </div>
